...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Produto p4 =  new Produto(null, "Teclado", 200.00);
		Produto p5 =  new Produto(null, "HD", 200.00);
		Produto p6 =  new Produto(null, "Memoria", 200.00);
		Produto p7 =  new Produto(null, "Monitor", 200.00);
		Produto p8 =  new Produto(null, "SSD", 200.00);
		
		cat1.getProdutos().addAll(Arrays.asList(p1,p2,p3,p4));
		cat2.getProdutos().addAll(Arrays.asList(p2,p5,p6,p7,p8));
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "23112311109", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("32324545","991123456"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "18090001", cli1, cid1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "18098123", cli1, cid2);
		...
		Pedido ped2 = new Pedido(null, sdf.parse("10/109/2017 11:32"), cli1, e2);
